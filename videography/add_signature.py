...
for filename in os.listdir("."):
    # Skip files that start with a dot and check for video file extensions
    if filename.startswith(".") or not filename.lower().endswith((".mp4", ".mov", ".avi", ".mkv")):
        continue  # Skip hidden files and non-video files
